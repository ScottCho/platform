...
# flask_app.config['UPLOADED_PHOTO_DEST'] = '/tmp'

# flask_app.config['UPLOADED_PHOTO_ALLOW'] = IMAGES
...
# @flask_app.route('/test2', methods=['POST', 'GET'])
# def upload():
...
# @flask_app.route('/photo/<name>')
# def show(name):
#     if name is None:
#         abort(404)
#     url = photos.url(name)
#     return render_template('test/show.html', url=url, name=name)
